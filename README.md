...
- 🎨 **Kebebasan Background Tanpa Batas**:
  ...
  - Unggah Foto Background Kustom milik sendiri dari galeri/perangkat.
...
1. Push repository ini ke GitHub kamu.
2. Buka [Vercel Dashboard](https://vercel.com/) dan import repository `violink.space`.
3. Masukkan `DATABASE_URL` dan `JWT_SECRET` pada **Environment Variables**.
4. Klik **Deploy**.
